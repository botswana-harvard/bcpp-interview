# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-06-03 09:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-history_date', '-history_id'),
                'verbose_name': 'historical Focus Group Discussion',
                'get_latest_by': 'history_date',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(editable=False, help_text='System field. UUID primary key.', primary_key=True, serialize=False)),
                ('subject_identifier', models.CharField(max_length=25, unique=True)),
                ('identity', django_crypto_fields.fields.identity_field.IdentityField(help_text=' (Encryption: RSA local)', max_length=71, null=True)),
                ('last_name', django_crypto_fields.fields.lastname_field.LastnameField(help_text=' (Encryption: RSA local)', max_length=71, null=True)),
                ('pair', models.CharField(max_length=25, null=True)),
                ('community', models.CharField(max_length=25, null=True)),
                ('intervention', models.CharField(max_length=25, null=True)),
                ('age_at_interview', models.CharField(max_length=25, null=True)),
                ('gender', models.CharField(max_length=25, null=True)),
                ('education', models.CharField(max_length=25, null=True)),
                ('working', models.CharField(max_length=25, null=True)),
                ('referral_appt_dt', models.CharField(max_length=25, null=True)),
                ('cd4_value', models.CharField(max_length=25, null=True)),
                ('viral_load', models.CharField(max_length=25, null=True)),
                ('final_arv_Status', models.CharField(max_length=25, null=True)),
                ('flag', models.CharField(max_length=25, null=True)),
                ('art_eligible', models.CharField(max_length=25, null=True)),
                ('art_eligible_natl', models.CharField(max_length=25, null=True)),
                ('art_eligible_expanded', models.CharField(max_length=25, null=True)),
                ('pims_registration_date', models.CharField(max_length=25, null=True)),
                ('pims_art_initiation_date', models.CharField(max_length=25, null=True)),
                ('pimsclinicname', models.CharField(max_length=25, null=True)),
                ('first_arv', models.CharField(max_length=25, null=True)),
                ('clinic_receiving_from', models.CharField(max_length=25, null=True)),
                ('on_arv', models.CharField(max_length=25, null=True)),
                ('why_no_arv', models.CharField(max_length=25, null=True)),
                ('t1_visit_date', models.CharField(max_length=25, null=True)),
                ('ref_code_t1', models.CharField(max_length=25, null=True)),
                ('issue', models.CharField(max_length=25, null=True)),
                ('elig_cat', models.CharField(max_length=25, null=True)),
                ...
                ('gender_plot', models.CharField(max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', django_revision.revision_field.RevisionField(blank=True, editable=False, help_text='System field. Git repository tag:branch:commit.', max_length=75, null=True, verbose_name='Revision')),
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(editable=False, help_text='System field. UUID primary key.', primary_key=True, serialize=False)),
                ('gps_confirm_latitude', models.DecimalField(decimal_places=10, max_digits=15, null=True, verbose_name='latitude')),
                ('gps_confirm_longitude', models.DecimalField(decimal_places=10, max_digits=15, null=True, verbose_name='longitude')),
                ('gps_target_lat', models.DecimalField(decimal_places=10, default=0.0, max_digits=15, null=True, verbose_name='target waypoint latitude')),
                ('gps_target_lon', models.DecimalField(decimal_places=10, default=0.0, max_digits=15, null=True, verbose_name='target waypoint longitude')),
                ...
                ('map_area', models.CharField(editable=False, help_text='If the area name is incorrect, please contact the DMC immediately.', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_cell', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=8, null=True, validators=[edc_base.model.validators.phone.CellNumber], verbose_name='Cell number')),
                ('contact_phone', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=8, null=True, validators=[edc_base.model.validators.phone.TelephoneNumber], verbose_name='Telephone number')),
                ('potential_subject', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bcpp_interview.PotentialSubject')),
            ],
        ),
        migrations.CreateModel(
            name='SubjectLoss',
            fields=[
                ...
                ('registered_subject', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='registration.RegisteredSubject')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registration.RegisteredSubject'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='interview',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='bcpp_interview.Interview'),
        ),
        migrations.AddField(
