# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-09 16:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community', models.CharField(max_length=25, verbose_name='Community')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_identifier', models.CharField(editable=False, max_length=25)),
                ('category', models.CharField(choices=[('not_linked', 'Not linked-to-care'), ('linked_only', 'Linked-to-care only'), ('initiated', 'Initiated ART')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('tn', 'Setswana'), ('en', 'English'), ('kck', 'Ikalanga'), ('hbs', 'Hambukushu')], default='not specified', help_text='The language used for the edc_consent process will also be used during data collection.', max_length=25, verbose_name='Language of edc_consent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', django_revision.revision_field.RevisionField(blank=True, editable=False, help_text='System field. Git repository tag:branch:commit.', max_length=75, null=True, verbose_name='Revision')),
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(editable=False, help_text='System field. UUID primary key.', primary_key=True, serialize=False)),
                ('subject_consent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bcpp_interview.SubjectConsent')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bcpp_interview.SubjectConsent'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='subjectgroupitem',
            unique_together=set([('subject_group', 'subject_consent')]),
        ),
        migrations.AlterUniqueTogether(
            name='subjectconsent',
