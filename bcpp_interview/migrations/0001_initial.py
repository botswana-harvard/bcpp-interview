# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-08 18:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', django_revision.revision_field.RevisionField(blank=True, editable=False, help_text='System field. Git repository tag:branch:commit.', max_length=75, null=True, verbose_name='Revision')),
                ('id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(editable=False, help_text='System field. UUID primary key.', primary_key=True, serialize=False)),
                ('start_datetime', models.DateTimeField(editable=False, null=True)),
                ('stop_datetime', models.DateTimeField(editable=False, null=True)),
                ('sound_file', models.FileField(null=True, upload_to='/Users/erikvw/source/bcpp-interview/bcpp_interview/media/upload')),
                ('sound_filename', models.CharField(max_length=50, unique=True)),
