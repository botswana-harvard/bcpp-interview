# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-29 16:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default=bcpp_interview.models.group_identifier, max_length=15, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(db_index=True, default=bcpp_interview.models.group_identifier, max_length=15)),
                ('size', models.IntegerField(verbose_name='How many consented subjects are in this focus group?')),
                ('category', models.CharField(choices=[('not_linked', 'Not linked-to-care'), ('linked_only', 'Linked-to-care only'), ('DEFAULTER', 'Defaulter'), ('initiated', 'Initiated ART'), ('t1_initiated', 'Initiated ART at T1')], max_length=25)),
                ('sub_category', models.CharField(choices=[('national_guidelines', 'by national guidelines'), ('expanded_guidelines', 'by expanded guidelines'), ('N/A', 'Not applicable')], help_text='Note: only applicable if subjects are initiated', max_length=25)),
